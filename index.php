               ...
               <div class="card-body">
                  <form action="data.php" method="post">
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                           <select name="waktu" id="inputWaktu" class="form-select" aria-label="Default select example">
                              <option disabled selected hidden>- Pilih Waktu -</option>
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                           <input type="text" class="form-control" id="inputMateri" name="materi" placeholder="Materi">
                        </div>
                     </div>
                     <div class="row mb-3">
                        <label for="inputInstruktur" class="col-sm-2 col-form-label">Instruktur</label>
                        <div class="col-sm-10">
                           <input type="text" class="form-control" id="inputInstruktur" name="instruktur" placeholder="Instruktur">
                        </div>
                     </div>
                     <div class="row">
